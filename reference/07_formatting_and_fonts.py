...
cell_example = my_workbook.active["A1"]
cell_example.font = Font(bold = True)
...
range_of_cells = my_workbook.active["A1:B2"]
...
B2_cell = my_workbook.active["B2"]
B2_cell_value = B2_cell.value
length_of_B3 = len(B2_cell_value)

my_workbook.active.column_dimensions["B"].width = length_of_B3 + 10
